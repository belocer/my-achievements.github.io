	...
	<body>
		...
		<div class="container" id="content">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2 class="featurette-heading">Памятка по уходу за ресницами.<br><span class="text-muted">Следуя этим простым правилам, Вы продлите срок носки искусственных ресниц и не навредите своим.</span></h2>
					<p class="lead"><span style="color: green;">*</span>В течении первых 24 часов после наращивания избегайте контакта с водой.</p>
			...
			<div class="row featurette">
				...
				<div class="col-md-7">
					...
					<p class="lead">Максимальная масса искусственной ресницы рассчитывается исходя из длины (3-12 мм) и толщины (0,05-0,11 мм) родной ресницы.
