...
<div id="content">
  ...
  <form action="index.php" method="POST">  
    Дата отсчета:<br> <input type="text" id="datepicker" size="25" name="dayMonthYear" placeholder="<?php echo date('d-m-Y');?>"><span id="one"></span><br><br>
	Количество дней:<br> <input type="text" name="day" id="numberOfDays" placeholder="Введите дни"><span id="two"></span><br><br>
    Количество часов:<br> <input type="text" name="hour" id="numberOfHours" placeholder="Введите часы"><span id="free"></span><br><br>
    Количество минут:<br> <input type="text" name="minute" id="numberOfMinutes" placeholder="Введите минуты"><span id="four"></span><br><br>
    Количество секунд:<br> <input type="text" name="second" id="numberOfSecond" placeholder="Введите секунды"><span id="five"></span><br><br>
    <input type="submit" name="button"  id="send" class="btn btn-ttc" value="Посчитать"><br><br>
  </form>
...
<h1 id="result" class="jumbotron container">
  ...
  //Сбор инфы из полей инпут
    $day = htmlspecialchars($_POST['day'], ENT_QUOTES, 'utf-8', false);
    $hour = htmlspecialchars($_POST['hour'], ENT_QUOTES, 'utf-8', false);
    $minute = htmlspecialchars($_POST['minute'], ENT_QUOTES, 'utf-8', false);
    $second = htmlspecialchars($_POST['second'], ENT_QUOTES, 'utf-8', false);
...
<form action="index.php" method="POST">
   ...
   <div class="form-group col-xs-4">
    ...
    <input type="text" class="form-control" placeholder="&#1048;&#1084;&#1103;" name="name">
   		...
   		<textarea class="form-control" rows="3" placeholder="Текст комментария" name="coment"></textarea><br>
